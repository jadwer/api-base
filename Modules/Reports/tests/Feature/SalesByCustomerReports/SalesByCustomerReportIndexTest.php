...
class SalesByCustomerReportIndexTest extends TestCase
{
    ...
    public function test_admin_can_fetch_sales_by_customer_reports()
    {
    ...
    public function test_tech_user_can_fetch_sales_by_customer_reports()
    {
    ...
    public function test_customer_cannot_fetch_sales_by_customer_reports()
    {
    ...
    public function test_guest_cannot_fetch_sales_by_customer_reports()
    {
    ...
    public function test_can_filter_sales_by_customer_report_by_date()
    {
        $admin = $this->getAdminUser();
    ...
    public function test_sales_by_customer_report_includes_all_sections()
    {
        $admin = $this->getAdminUser();
    ...
    public function test_sales_by_customer_report_includes_summary()
    {
        $admin = $this->getAdminUser();
