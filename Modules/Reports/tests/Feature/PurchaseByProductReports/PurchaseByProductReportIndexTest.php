...
class PurchaseByProductReportIndexTest extends TestCase
{
    ...
    /** @test */
    public function admin_can_fetch_purchase_by_product_reports()
    {
    ...
    /** @test */
    public function tech_user_can_fetch_purchase_by_product_reports()
    {
    ...
    /** @test */
    public function customer_cannot_fetch_purchase_by_product_reports()
    {
    ...
    /** @test */
    public function guest_cannot_fetch_purchase_by_product_reports()
    {
    ...
    /** @test */
    public function can_filter_purchase_by_product_report_by_date()
    {
        $admin = $this->getAdminUser();
    ...
    /** @test */
    public function purchase_by_product_report_includes_all_sections()
    {
        $admin = $this->getAdminUser();
    ...
    /** @test */
    public function purchase_by_product_report_includes_summary()
    {
        $admin = $this->getAdminUser();
