...
class PurchaseBySupplierReportUpdateTest extends TestCase
{

    public function test_cannot_update_purchase_by_supplier_reports()
    {
        ...
        $response = $this->actingAs($admin, 'sanctum')
            ...
            ->withData($data)
            ->patch('/api/v1/reports/purchase-by-supplier-reports/1');
