...
class SalesByCustomerReportController extends Controller
{
    ...
    /**
     * Fetch sales by customer reports
     *
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $data = $this->salesByCustomerReportService->generate($startDate, $endDate, $currency);
    ...
    /**
     * Fetch a single sales by customer report
     *
    ...
    {
        // Check authorization
        if ($error = $this->authorize($request, 'reports.sales-by-customer-reports.show')) {
            return $error;
        }
