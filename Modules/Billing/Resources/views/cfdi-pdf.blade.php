    ...
    <div class="container">
        ...
        <div class="header clearfix">
            <div class="header-left">
                <div class="company-name">{{ $settings->legal_name }}</div>
                <div class="company-info">
                    <div><strong>RFC:</strong> {{ $settings->rfc }}</div>
                    <div><strong>Régimen Fiscal:</strong> {{ $settings->fiscal_regime }} - @if($settings->fiscal_regime == '612') Personas Físicas con Actividades Empresariales @else Régimen General @endif</div>
                    <div><strong>Domicilio Fiscal:</strong> {{ $settings->tax_domicile }}</div>
