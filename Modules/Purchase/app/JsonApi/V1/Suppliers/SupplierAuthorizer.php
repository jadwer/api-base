...
class SupplierAuthorizer implements Authorizer
{
    /**
    ...
    {
        return $request->user()?->can('suppliers.index', 'api') ?? false;
    }
    ...
    {
        return $request->user()?->can('suppliers.store', 'api') ?? false;
    }
    ...
    {
        return $request->user()?->can('suppliers.show', 'api') ?? false;
    }
    ...
    {
        return $request->user()?->can('suppliers.update', 'api') ?? false;
    }
    ...
    {
        return $request->user()?->can('suppliers.destroy', 'api') ?? false;
    }
