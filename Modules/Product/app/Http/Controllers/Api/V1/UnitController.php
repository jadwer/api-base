...
class UnitController extends Controller
{
    ...
    /**
     * Delete a unit with proper error handling for foreign key constraints.
     */
    public function destroy(Route $route, Store $store)
    {
        try {
            ...
            if ($e->getCode() === '23000') {
                $error = Error::make()
                    ->setStatus('409')
                    ->setTitle('Cannot Delete Unit')
                    ->setDetail('This unit cannot be deleted because it has associated products. Please remove or reassign the products first.')
