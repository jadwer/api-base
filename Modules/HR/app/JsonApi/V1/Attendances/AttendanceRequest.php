...
class AttendanceRequest extends ResourceRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'checkIn' => [
                'nullable',
                'regex:/^\d{2}:\d{2}(:\d{2})?$/',  // Accept HH:MM or HH:MM:SS
            ],
            'checkOut' => [
                'nullable',
                'regex:/^\d{2}:\d{2}(:\d{2})?$/',  // Accept HH:MM or HH:MM:SS
    ...
    public function messages(): array
    {
        return [
            ...
            'checkIn.regex' => 'La hora de entrada debe tener el formato HH:MM o HH:MM:SS.',
            'checkOut.regex' => 'La hora de salida debe tener el formato HH:MM o HH:MM:SS.',
