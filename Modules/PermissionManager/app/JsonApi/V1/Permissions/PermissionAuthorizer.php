...
class PermissionAuthorizer implements Authorizer
{
    ...
    {
        return $request->user()?->can('permissions.index') ?? false;
    }
    ...
    {
        return $request->user()?->can('permissions.store') ?? false;
    }
    ...
    {
        return $request->user()?->can('permissions.view') ?? false;
    }
    ...
    {
        return $request->user()?->can('permissions.update') ?? false;
    }
    ...
    {
        return $request->user()?->can('permissions.destroy') ?? false;
    }
