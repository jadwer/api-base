...
class ARInvoiceShowTest extends TestCase
{
    ...
    public function test_admin_can_view_ARInvoice_with_specific_data(): void
    {
        ...
        $aRInvoice = ARInvoice::factory()->create(['invoice_number' => 'test string', 'invoice_date' => now(), 'due_date' => now(), 'currency' => 'test string', 'subtotal' => 99.99, 'tax_amount' => 99.99, 'total_amount' => 99.99, 'paid_amount' => 99.99, 'status' => 'active', 'notes' => 'test description', 'metadata' => 'test value', 'is_active' => true]);
