...
class PaymentDestroyTest extends TestCase
{
    ...
    public function test_admin_can_delete_Payment_with_metadata(): void
    {
        $admin = $this->getAdminUser();
        $payment = Payment::factory()->create([
            'metadata' => [
    ...
    public function test_can_delete_inactive_Payment(): void
    {
        $admin = $this->getAdminUser();
    ...
    public function test_customer_user_cannot_delete_Payment(): void
    {
