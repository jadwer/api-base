...
class APInvoiceStoreTest extends TestCase
{
    ...
    public function test_admin_can_create_APInvoice(): void
    {
        ...
        $this->assertDatabaseHas('ap_invoices', ['invoice_number' => 'test string', 'invoice_date' => 'test value', 'due_date' => 'test value', 'currency' => 'test string', 'exchange_rate' => 99.99, 'subtotal' => 99.99, 'tax_total' => 99.99, 'total' => 99.99, 'status' => 'active']);
    }
