...
class ExchangeRateShowTest extends TestCase
{
    ...
    public function test_admin_can_view_ExchangeRate_with_specific_data(): void
    {
        ...
        $exchangeRate = ExchangeRate::factory()->create(['from_currency' => 'test string', 'to_currency' => 'test string', 'rate' => 99.99, 'effective_date' => now(), 'source' => 'test string', 'status' => 'active', 'metadata' => 'test value']);
