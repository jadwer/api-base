...
class JournalShowTest extends TestCase
{
    ...
    public function test_admin_can_view_Journal_with_specific_data(): void
    {
        ...
        $journal = Journal::factory()->create(['code' => 'TEST123', 'name' => 'Test Name', 'auto_numbering' => true, 'sequence_prefix' => 'test string', 'sequence_next' => 100, 'default_currency' => 'test string', 'post_policy' => 'test string']);
