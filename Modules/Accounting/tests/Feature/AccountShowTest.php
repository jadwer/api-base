...
class AccountShowTest extends TestCase
{
    ...
    public function test_admin_can_view_Account_with_specific_data(): void
    {
        ...
        $account = Account::factory()->create(['code' => 'TEST123', 'name' => 'Test Name', 'account_type' => 'test string', 'level' => 100, 'currency' => 'test string', 'is_postable' => true, 'status' => 'active', 'metadata' => 'test value']);
